...
train_model='./snapshot/my_mobilenet_ssd_iter_10000.caffemodel'
train_proto = './examples/mobile_ssd/MobileNetSSD_train.prototxt'

deploy_proto = './examples/mobile_ssd/MobileNetSSD_deploy.prototxt'
save_model = './snapshot/my_mobilenet_ssd_iter_10000_deploy.caffemodel'
