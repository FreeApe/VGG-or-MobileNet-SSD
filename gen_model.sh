...
cls_num3=$(expr $1 \* 3)
cls_num6=$(expr $1 \* 6)
trainfile=examples/mobile_ssd/MobileNetSSD_train.prototxt
testfile=examples/mobile_ssd/MobileNetSSD_test.prototxt
deploybnfile=examples/mobile_ssd/MobileNetSSD_deploy_bn.prototxt
deployfile=examples/mobile_ssd/MobileNetSSD_deploy.prototxt

mkdir -p examples/mobile_ssd
